...
public class TurmaAdicionarBotao implements ActionListener{
	...
	public TurmaAdicionarBotao(JTextField idInstrutor, JTextField idAtividade, JTextField idMonitor,
			JTextField dataInicio, JTextField horario, JTextField qtdAluno) {
		super();
	...
	public void actionPerformed(ActionEvent e) {
		...
		Turma turma = new Turma(dataIncioTurma, null, horarioTurma, qtdAlunoTurma, instrutor, 
				atividade, aluno);
